  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-linear-to-br from-blue-200 to-purple-400'>
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        <h2 className='text-3xl font-semibold text-white text-center mb-3'>Log in your Account !</h2>
        <form action="">
          {/* email */}
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input type={showPassword ? 'text' : 'password'} placeholder='Password' required className='bg-transparent outline-none' />

          </div>
          <p className='mb-4 text-indigo-500 cursor-pointer'>Forgot Password ?</p>
          <button className='py-2.5 w-full rounded-full bg-linear-to-br from-indigo-500 to-purple-900 text-white font-medium cursor-pointer'>login</button>
        </form>
        <p className='text-gray-400 mt-4 text-center text-xs'>Don't have an account ? <span className='text-blue-400 underline cursor-pointer'>Signup here</span></p>
      </div>
    </div>
  )
}
