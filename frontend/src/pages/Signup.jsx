      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form action="">
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input type="text" placeholder='Name' required className='bg-transparent outline-none' />
          </div>
          {/* email */}
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
          ...
          <button className='py-2.5 w-full rounded-full bg-linear-to-br from-indigo-500 to-purple-900 text-white font-medium cursor-pointer'>Signup</button>
        </form>
